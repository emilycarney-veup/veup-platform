...
export default function PLGActionPlan() {
  ...
  const addAction = () => {
    const newId = data.actions.length > 0 ? Math.max(...data.actions.map(a => a.id)) + 1 : 1;
    setData(prev => ({
      ...prev,
      actions: [...prev.actions, { id: newId, category: 'Marketplace', action: '', owner: '', targetDate: '', status: 'Not Started' }]
    }));
  };
  ...
  return (
    <div className="activity-container">
      <div className="activity-header">
        ...
        <p>Convert your Readiness Assessment into an actionable roadmap.</p>
      </div>
