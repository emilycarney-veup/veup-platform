  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        content: "<h3>Growing in the AWS Partner Network</h3><p>Your journey inside the APN (AWS Partner Network) is defined by tiers: Enrolled, Validated, and Differentiated. To achieve maximum visibility and secure the highest levels of Marketing Development Funds (MDF), you must systematically upgrade your tier.</p><p>The ultimate gateway to becoming a 'Validated Partner' is passing the Foundational Technical Review (FTR). The FTR enables AWS Partners to qualify their software products that run on or integrate with AWS. Based on the AWS Well-Architected Framework, it evaluates four essential pillars: <strong>Security, Resilience, Performance, and Supportability</strong>. Passing the FTR is a prerequisite for high-value programs like ISV-Accelerate, AWS Competency, and Service Ready Specializations, and remains valid for three years from approval.</p><p>To progress successfully, you must organize your engineering team to run an exhaustive Self-Assessment using the official rubrics prior to submission. You must also ensure you are subscribed to the AWS Business Support tier (or higher) for all production AWS accounts. VeUP specializes in accelerating this phase, utilizing automated tools to map your infrastructure against the FTR rubric.</p><div class=\"activity-box\"><h4>Activity: Execute the FTR Self-Assessment</h4><p>Download the official FTR Self-Assessment resources from the Activities section. Ensure your Technical Lead completes the Security Pillar (e.g., scoping IAM to least privilege, encrypting data at rest and transit) and Resilience Pillar (e.g., Multi-AZ, backup/restore) grading to identify immediate red flags.</p></div>"
      },
      {
        id: "m2-3",
