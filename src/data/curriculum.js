export const curriculum = [
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        content: "<h3>Growing in the AWS Partner Network</h3><p>Your journey inside the APN is defined by tiers: Enrolled, Validated, and Differentiated. To achieve maximum visibility and secure the highest levels of Marketing Development Funds (MDF), you must systematically upgrade your tier.</p><h3>The Foundational Technical Review (FTR)</h3><p>The ultimate gateway to becoming a 'Validated Partner' is passing the <strong>Foundational Technical Review (FTR)</strong>. The FTR qualifies software products that run on or integrate with AWS. Completing an FTR allows your solution to be listed in the AWS Partner Solutions Finder, grants AWS badging, and is a prerequisite for critical programs like ISV-Accelerate, AWS Competency, and Service Ready Specializations. The FTR is valid for three years from the approval date.</p><h3>The Well-Architected Review (WAFR)</h3><p>The FTR defines best practices based on the AWS Well-Architected Framework. If your team needs guidance meeting these standards, you can find confirmed Well-Architected Partner Program (WAPP) Partners to perform a Well-Architected Framework Review (WAFR). You can search for WAPP partners tailored to your industry and AWS services directly within the Partner Solutions Finder.</p><h3>Expediting FTR with SOC 2 Type II</h3><p>Leveraging a <strong>SOC 2 Type II report</strong> can significantly expedite the FTR process for AWS Partners. To use this pathway, download the Partner Hosted Alternative Checklist and submit your FTR request in Partner Central. You must include your SOC 2 Type II report, CIS Benchmark Report, the Alternative Checklist, and an Architecture Diagram.</p><div class=\"activity-box\"><h4>Activity: Execute the FTR Self-Assessment</h4><p>Download the official FTR Self-Assessment resources from the Activities section. Mandate that your Technical Lead completes the assessment grading prior to submission, highlighting any immediate red flags.</p></div>"
      },
      {
        id: "m2-3",
        title: "Certifications and Competencies",
        content: "<h3>Accreditations vs. Certifications</h3><p>To prepare your organization for APN tier progression (Select, Advanced, Premier) and to achieve specialized Competencies, your team must consistently upskill. AWS differentiates between Accreditations and Certifications.</p><p><strong>Accreditations</strong> focus on AWS partnership, sales, and core technical knowledge. They are completed online through AWS Partner Central and require periodic renewal. <strong>Certifications</strong> represent deeply validated technical or business expertise, obtained via rigorous AWS Training and Certification exams, and are valid for three years.</p><h3>AWS Certification Levels</h3><p>Your team's certification strategy should encompass the following levels to meet tier requirements:</p><ul><li><strong>Foundational:</strong> AWS Certified Cloud Practitioner. Focuses on AWS fundamentals, billing, and compliance. Target audience: Business professionals and non-technical roles. ($100 exam cost).</li><li><strong>Associate:</strong> Solutions Architect, Developer, or SysOps Administrator. Focuses on designing, developing, and operating resilient systems. Target audience: Technical professionals. ($150 exam cost).</li><li><strong>Professional:</strong> Solutions Architect Pro or DevOps Engineer Pro. Focuses on complex, large-scale solutions design and automation. Target audience: Senior technical professionals. ($300 exam cost).</li><li><strong>Specialty:</strong> Security, Machine Learning, Data Analytics, etc. Target audience: Subject matter experts. ($300 exam cost).</li></ul><h3>Scorecard Integration & Financial Benefits</h3><p>For certifications to count toward your Partner Scorecard, team members must pass exams using their AWS Partner Central email address or link their CertMetrics account to their profile. Allow 5 business days for certifications to synchronize.</p><p>AWS actively rewards certification achievements. Partners receive <strong>AWS Promotional Credits</strong> for new certifications earned: $300 for each Associate-level certification (up to 2 per year) and $500 for each Professional or Specialty certification (up to 5 per year).</p><h3>Achieving AWS Competencies</h3><p>Once your team is highly certified, the ultimate goal is achieving a specialized Competency (e.g., Security, Healthcare). Competencies reflect immense product maturity and proven historical success in specific verticals. Achieving a Competency grants VIP placement in the Partner Solutions Finder, unlocks maximum tiers of marketing funds, and provides direct introductions to specialized AWS sales teams. AWS will demand extensive technical whitepapers, architectural diagrams, and multiple verified case studies showing massive scale.</p>"
      }
    ]
  },
  {
  ...
  },
  {
    ...
    sections: [
      ...
      {
        id: "m4-4",
        title: "ACE Pipeline Dynamics & Management",
        content: "<h3>Mastering the ACE Pipeline Manager</h3><p>The APN Customer Engagements (ACE) Pipeline Manager provides full-service management of your pipeline of AWS customers. It is the central hub where you submit Partner Opportunity Referrals, receive AWS Opportunity Referrals, and collaborate with AWS Sales teams. Maintaining pristine pipeline hygiene guarantees that AWS reps trust the leads you send them.</p><h3>Opportunity Submission & Validation</h3><p>Opportunities must represent net-new AWS business. The standard Service Level Agreement (SLA) for initial review by the AWS validation team is 5 business days. Opportunities may be placed in a <em>Secondary Review</em> if information is incomplete (commonly needing 'Clarify Solution' or 'Clarify Revenue'). You must explicitly have the customer's legal permission to share their operational data before submitting.</p><h3>Bi-Weekly Opportunity Updates</h3><p>Partners are strictly expected to update validated opportunities (Status = 'Approved') with new sales activities on a bi-weekly basis. At a minimum, 'Next Steps' must be continuously updated. Critical milestones include:</p><ul><li><strong>Solution ID Requirement:</strong> Adding a validated Solution ID to an opportunity is a mandatory requirement to move it to the 'Committed' or 'Launched' sales stages.</li><li><strong>Account ID Requirement:</strong> For Service Path partners, setting an opportunity to 'Launched' requires providing the customer's AWS Account ID.</li></ul><h3>Collaboration & Multi-Partner Sharing</h3><p>The ACE experience introduces powerful collaboration tools:</p><ul><li><strong>Slack Collaboration Channels:</strong> Eligible partners can request instant connection with their AWS Opportunity Team via the AWS Secure Connect App on Slack directly from the opportunity record. This is enabled for high-value, co-sell opportunities in the Qualified-to-Committed stages.</li><li><strong>Multi-Partner Opportunities (Partner Connections):</strong> Allows you to seamlessly associate up to 10 partners to a single opportunity, enabling joint sales and secure pipeline sharing between distributors, ISVs, and consulting partners.</li></ul><p>For ACE-eligible partners receiving <strong>AWS Opportunity Referrals</strong>, remember that you only have limited information initially. You must accept the opportunity within 5 business days to unlock full customer contact details and collaborate with the AWS Account Manager.</p>"
      }
    ]
  },
  {
    ...
    sections: [
      {
        id: "m5-1",
        title: "The Marketplace Vehicle",
        content: "<h3>Accelerating Global Expansion</h3><p>Cloud marketplaces serve as an exceptional vehicle for international growth because they abstract away immense transactional complexity. When expanding into new regions, software companies face hurdles with local currencies, specific payment methods, localized tax requirements (like VAT or GST), and diverse regulatory compliance needs.</p><p>By leveraging the marketplace as the transaction layer, you bypass the need to independently build this infrastructure. Furthermore, you gain immediate access to a built-in buyer community. Instead of spending years building a localized distribution network from scratch, you tap into an existing ecosystem where major enterprises have already centralized their cloud procurement and committed budgets.</p>"
      },
      {
        id: "m5-2",
        title: "Strategic Market Selection",
        content: "<h3>Data-Driven Expansion</h3><p>A common pitfall in global expansion is moving too quickly based on isolated demand—such as a single inbound prospect—without considering long-term scalability. An intelligent market selection process requires evaluating multiple dimensions: market size, cloud maturity, competitive landscape, ease of doing business, and the strength of the local partner ecosystem.</p><p>Remember that <em>proximity does not equal priority</em>. You must utilize a rigorous scoring model to determine your highest-probability market rather than simply expanding to the nearest geographic region. Your goal is to select a primary target, secure a definitive win, extract learnings, and use that success as a template for subsequent regions. Sequencing your expansion deliberately is far more effective than attempting to enter multiple markets simultaneously.</p>"
      },
      {
        id: "m5-3",
        title: "Operational & Financial Infrastructure",
        content: "<h3>The Hidden Complexities</h3><p>Success internationally is rarely constrained by the product itself; it is determined by operational readiness. You must address several critical infrastructure components:</p><ul><li><strong>Pricing and Packaging:</strong> Does your home-market pricing model translate effectively? You must adapt to local currency expectations and regional enterprise packaging preferences.</li><li><strong>Legal and Compliance:</strong> Different regions require distinct End User License Agreements (EULAs), Data Processing Agreements (DPAs), and strict adherence to privacy frameworks (e.g., GDPR).</li><li><strong>Entity Structure and Tax:</strong> While the marketplace handles significant tax collection and remittance, you may still have obligations regarding local invoicing, transfer pricing, and intercompany revenue flow depending on your corporate entity structure.</li><li><strong>Fulfillment and Support:</strong> Securing a customer is only the first step. You must be prepared to offer onboarding and technical support across different time zones and languages to ensure a flawless first-customer experience.</li></ul>"
      },
      {
        id: "m5-4",
        title: "Execution & Repeatability",
        content: "<h3>Building the Global Playbook</h3><p>The organizations that scale successfully globally are those that build a repeatable engine. They do not treat each new market as a bespoke, heroic effort. Instead, they document their market entry playbook, partner enablement models, and support infrastructure. When they enter the next market, they adapt the proven playbook rather than starting from scratch.</p><p>Crucially, international expansion cannot be treated as a \"side project.\" It requires dedicated focus, adequate resourcing, and an acknowledgment that you must adapt your messaging to local nuances rather than blindly copying your home-market strategy. By executing sequentially and leaning heavily on local partners to bridge any gaps in the direct co-sell motion, you establish a resilient foundation for continuous global growth.</p>"
      }
    ]
  },
  {
    ...
    sections: [
      {
        id: "m6-1",
        title: "AWS Partner Funding Benefits",
        content: "<h3>Introduction to Partner Funding</h3><p>As you grow your AWS-based practice and deepen your knowledge of AWS, you have the opportunity to unlock AWS Partner Funding Benefits. These benefits offer funding to accelerate various stages of AWS Partners’ business development, including technical, sales, and marketing enablement. Funding is provided as either Cash (to offset partner costs/professional service fees) or AWS Promotional Credits (to offset future AWS spend).</p><h3>Offered Funding Programs</h3><p><strong>Build Benefits</strong></p><ul><li><strong>Training and Certification:</strong> AWS Training & Certification’s Partner offerings provide resources to increase Partners’ AWS knowledge, ranging from digital training to virtual instructor-led sessions.</li><li><strong>Innovation Sandbox Credit:</strong> Offers up to three months of associated AWS usage costs with APN Innovation Sandbox credits (up to $100K USD per year) to support new solution development or design wins.</li></ul><p><strong>Market Benefits</strong></p><ul><li><strong>Marketing Development Funds (MDF):</strong> Co-invests up to 50% of actual marketing costs to create and nurture leads, build sales pipelines, and drive brand awareness.</li></ul><p><strong>Sell & Grow Benefits</strong></p><ul><li><strong>Proof of Concept (POC):</strong> Supports small-scale projects for customers to demonstrate the feasibility of AWS cloud adoption or pivot an existing solution.</li><li><strong>Customer Engagement Incentive (CEI):</strong> Supports Partners engaging Greenfield companies in the early stages of AWS adoption.</li><li><strong>Migration Acceleration Program (MAP):</strong> A comprehensive cloud migration program offering automation tools and financial investments across three phases: Assess, Mobilize, and Migrate & Modernize.</li><li><strong>ISV Workload Migration Program (WMP):</strong> Supports APN Software Partners in accelerating customer migrations to their SaaS solutions on AWS with funding and technical enablement.</li><li><strong>Marketplace Private Offer Promotion Program (MPOPP):</strong> Allows participating ISVs to offer AWS credits to customers as an incentive to make purchases via AWS Marketplace Private Offers.</li></ul><p><strong>Other:</strong> The Partner Initiative Funding (PIF) Template in APFP houses smaller, often \"invite only\" funding benefits.</p>"
      },
      {
        id: "m6-2",
        title: "Executing Fund Claims",
        content: "<h3>The Funding Lifecycle</h3><p>Navigating the AWS Partner Funding Portal (APFP) requires strict adherence to compliance guidelines. The fundamental rule of AWS Funding is: <strong>Claims must always be pre-approved.</strong> Fund claims will not be approved if work started prior to pre-approval.</p><h3>Detailed Process</h3><ol><li><strong>Setup Payee Central:</strong> Before submitting any cash requests, you must complete an Amazon Payee Central account setup, including bank registration and tax interviews. The currency must match your funding request.</li><li><strong>Submit Request:</strong> Provide activity information to the APN funding team via the APFP or through your Partner Development Manager (PDM).</li><li><strong>AWS Pre-Approval:</strong> The APN funding team reviews the project request against program guidelines.</li><li><strong>Execute Activity:</strong> Only <em>after</em> pre-approval can you execute the activity or project.</li><li><strong>Submit Claim (Actuals):</strong> Submit the fund claim with the required proof of execution and actual spend data by the established deadlines.</li><li><strong>Approval:</strong> If all requirements are met, the claim is approved. If rejected, you must update the claim based on feedback and resubmit.</li><li><strong>Invoicing:</strong> Upon fund claim approval, submit a webform invoice in Amazon Payee Central against the purchase order to initiate payment.</li></ol><div class=\"activity-box\"><h4>Activity: Explore the Funding Dashboard</h4><p>Navigate to the Funding Dashboard in the Activities section. Review the available funding categories and explicitly map out the 7-step claim lifecycle with your team to ensure you do not forfeit any pre-approved funds.</p></div>"
      },
      {
        id: "m6-3",
  ...
  },
  {
    ...
    sections: [
      ...
      {
        id: "m7-5",
        title: "The Evolution to Agentic SaaS",
        content: "<h3>From SaaS to Agentic SaaS</h3><p>We are witnessing the next major evolutionary step: <strong>Agentic SaaS</strong>. The convergence of GenAI, autonomous agents, cloud infrastructure, and modern data analytics unlocks entirely new capabilities. Instead of forcing users to explore complex interfaces to find value, intelligent agents observe intent and deliver outcomes directly.</p><p>A mature Agentic PLG strategy utilizes Four Intelligent Agents:</p><ul><li><strong>Onboarding Agent:</strong> Analyzes your stack, configures environments, and integrates services automatically, turning hours of setup into minutes.</li><li><strong>Experience Agent:</strong> Acts as a daily co-pilot, monitoring usage patterns and proactively suggesting workflow optimizations.</li><li><strong>Monetization Agent:</strong> Identifies value realization moments and determines optimal upgrade timing based on clear ROI calculations.</li><li><strong>Retention Agent:</strong> Predicts and prevents churn by monitoring behavioral drop-offs and guiding strategic growth.</li></ul><p>When these agents learn together, they create a <strong>Compound Intelligence</strong> network where every solved challenge becomes an automated preventative measure for the rest of the customer base.</p>"
      },
      {
        id: "m7-6",
        title: "The AWS List & Sell Program",
        content: "<h3>Accelerating PLG via AWS Marketplace</h3><p>The PLG \"Bowtie Model\" thrives on AWS Marketplace because it removes procurement friction. The expansion phase scales naturally across 5 stages: Builders & Architects discover the tool &rarr; they become Internal Champions &rarr; they win over Approvers (Legal/Sec) &rarr; Executives endorse the ROI &rarr; Expansion into New Teams.</p><p>To support this, the <strong>AWS List & Sell Program</strong> offers a structured pathway with three tiers:</p><ol><li><strong>Initial Marketplace Traction:</strong> The entry point requiring $65K TCV, 10 private offers, or $5.5K MRR to establish a basic presence.</li><li><strong>Co-Sell Ready:</strong> Focused on AWS sales collaboration. Requires completing the FTR and unlocks access to AWS sales teams for joint selling.</li><li><strong>PLG Ready:</strong> The premium tier for PLG-driven companies. It includes robust features like free trials, usage-based pricing, and the \"Buy with AWS\" button. It also offers significant financial benefits (Up to $8K cash + $6K credits) to accelerate organic product adoption.</li></ol>"
      },
      {
        id: "m7-7",
        title: "SaaS Control Plane & Pricing Architecture",
        content: "<h3>Architecting for Self-Serve Growth</h3><p>Self-serve products demand self-serve pricing. Your technical architecture must support transparent, value-aligned billing. This is where the <strong>SaaS Control Plane</strong> becomes your PLG Command Center. It sits behind the scenes handling tenant onboarding, complex billing logic, and usage metrics, completely separated from your core Application Plane.</p><p>Your pricing must offer a clear progression:</p><ul><li><strong>Free Trials / Freemium:</strong> Lower the barrier to entry so users can immediately experience value. The architecture must effectively isolate free tier tenants from standard paying customers to ensure performance and security.</li><li><strong>Pay-As-You-Go (Usage-Based):</strong> This flexible model serves as a proving ground, allowing customers to scale their AWS spend directly alongside their consumption without large upfront commitments.</li><li><strong>Contract-Based (Enterprise):</strong> For validated, high-volume customers seeking predictable costs and volume discounts.</li></ul><p>When you combine observable metering with the SaaS Control Plane, your business teams gain the real-time telemetry needed to spot expansion opportunities and automate upsell conversions.</p>"
      }
    ]
  },
  {
